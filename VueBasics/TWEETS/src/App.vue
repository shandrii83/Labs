<template>
  <div class="app">
    ...
    v-bind:imageSrcPadre="tweet.user.image"
    v-bind:imageAltPadre="tweet.user.alt"
    v-bind:usuarioNombrePadre="tweet.user.name" 
    v-bind:usuarioHandlePadre="tweet.user.handle"
